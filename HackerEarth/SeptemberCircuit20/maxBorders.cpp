...
int main()
{
    ...
    while (t--)
    {
        ...
        //CHECK FOR MAXBORDER HORIZONTALLY
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            while (j < m)
            {
                if (shape[i][j] == '#')
                {
                    if ((i == 0 || (i > 0 && shape[i - 1][j] != '#')) || (i == n - 1 || (i < n - 1 && shape[i + 1][j] != '#')))
                    {
                        border++;
                        j++;
                        while (j < m && shape[i][j] == '#')
        ...
        //CHECK FOR MAXBORDER VERTICALLY
        ...
        for (int i = 0; i < m; i++)
        {
            ...
            while (j < n)
            {
                if (shape[j][i] == '#')
                {
                    if ((i == 0 || (i > 0 && shape[j][i - 1] != '#')) || (i == m - 1 || (i < m - 1 && shape[j][i + 1] != '#')))
                    {
                        border++;
                        j++;
                        while (j < n && shape[j][i] == '#')
